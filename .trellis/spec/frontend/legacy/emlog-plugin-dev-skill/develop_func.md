...
应用可以直接使用 plog 系统内置的类和方法，能够提高开发效率，可以直接用于模板和插件开发的通用方法和函数。
...
- 对接支付：安装并配置 [支付 SDK 插件](https://www.plog.net/plugin/detail/726) 
  
## 订单系统

plog核心内置了订单表及订单数据模型来管理订单，见： include/model/order_model.php
