...
<footer class="sticky-footer bg-white">
    <div class="text-right my-auto mr-4">
        <small><a href="https://www.plog.net" target="_blank">PLOG</a> - <?= ucfirst(Option::PLOG_VERSION) ?></small>
    </div>
</footer>
<!-- AI Chat Modal -->
...
<script src="./views/js/sb-admin-2.min.js?t=<?= Option::PLOG_VERSION_TIMESTAMP ?>"></script>
<script>
    $(function() {
