...
<script src="./views/js/dropzone.min.js?t=<?= Option::PLOG_VERSION_TIMESTAMP ?>"></script>
<link rel="stylesheet" type="text/css" href="./views/components/highslide/highslide.css?t=<?= Option::PLOG_VERSION_TIMESTAMP ?>" />
<script src="./views/components/highslide/highslide.min.js?t=<?= Option::PLOG_VERSION_TIMESTAMP ?>"></script>
<script>
