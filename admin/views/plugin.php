...
<?php if (isset($_GET['error_i'])): ?>
    <div class="alert alert-danger"><?= _lang('plog_not_registered') ?></div><?php endif ?>
                    ...
                    ?>
                            <tr data-active="<?= $val['active'] ?>" data-plugin-alias="<?= $val['Plugin'] ?>" data-plugin-version="<?= $val['Version'] ?>" data-plugin-setting-url="<?= $plugin_setting_url ?>" data-plugin-show-url="<?= $val['ShowUrl'] ?>" data-plugin-name="<?= htmlspecialchars($val['Name']) ?>">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <div class="align-items-center mb-3">
                                                ...
                                                <p class="mb-0 m-2 small"><?= $val['Description'] ?> <?php if (strpos($val['Url'], 'https://www.plog.net') === 0): ?><a href="<?= $val['Url'] ?>" target="_blank"><?= _lang('more_info') ?>&raquo;</a><?php endif ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div class="mt-3">
                                        <?php if ($val['Author'] != ''): ?>
                                            <?php if (strpos($val['AuthorUrl'], 'https://www.plog.net') === 0): ?>
