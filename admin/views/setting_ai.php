...
<script>
    ...
    function getChatModelExamples() {
        return `
            ...
            <hr>
            <?= _lang('support_openai_model'); ?>，<a href="https://www.plog.net/docs/ai/ai_plog" target="_blank"><?= _lang('more_ai_models'); ?></a><br>
        `;
    }
    ...
    function getImageModelExamples() {
        return `
            ...
            <hr>
            <?= _lang('support_openai_image_model'); ?>，<a href="https://www.plog.net/docs/ai/ai_plog" target="_blank"><?= _lang('more_ai_models'); ?></a><br>
        `;
    }
</script>
