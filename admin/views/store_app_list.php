    ...
    <?php if (!empty($apps)): ?>
        <div class="d-flex flex-wrap app-list">
            <?php foreach ($apps as $k => $v):
                ...
                $order_url = 'https://www.plog.net/order/submit/' . $type . '/' . $v['id']
            ?>
                    ...
                    <div class="card mb-4 shadow-sm hover-shadow-lg">
                        ...
                        <div class="card-body">
                            <p class="card-text font-weight-bold">
                                ...
                                <?php endif; ?>
                                <?php if ($v['svip']): ?>
                                    <a href="https://www.plog.net/register" class="badge badge-warning p-1" target="_blank"><?= _lang('store_svip_badge') ?></a>
                                <?php endif; ?>
                            </p>
                ...
                success: function(response) {
                    if (response.code === 200 && response.data.apps.length > 0) {
                        ...
                        response.data.apps.forEach(function(app) {
                            ...
                            const orderUrl = 'https://www.plog.net/order/submit/' + type + '/' + app.id;
                                    ...
                                    <div class="card mb-4 shadow-sm hover-shadow-lg">
                                        ...
                                        <div class="card-body">
                                            <p class="card-text font-weight-bold">
                                                ...
                                                ${app.svip ? '<a href="https://www.plog.net/register" class="badge badge-warning p-1" target="_blank"><?= _lang("store_svip_badge") ?></a>' : ''}
                                            </p>
                                            <p class="card-text text-muted">
                                                <?= _lang("store_price") ?>
                                                ${app.price > 0 ? 
