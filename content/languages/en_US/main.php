...
return [
    ...
    'store_register_error' => 'please Register Now. <a href="https://www.plog.net/register" target="_blank">Register Now</a>',
    ...
    'store_favorite_need_auth' => 'This feature is currently unavailable. Please Register Now. <a href="https://www.plog.net/register">Register Now</a>',
    'store_no_favorite' => 'No favorites yet.',
    'store_mine_need_auth' => 'This feature is currently unavailable. Please Register Now. <a href="https://www.plog.net/register">Register Now</a>',
    ...
    'plog_not_registered' => 'Your plog is not Registered.',
    'plugin_register_error_link' => 'Your plog is not Registered, <a href="https://www.plog.net/register" target="_blank">Register Now</a>',
    ...
    'import_backup_desc' => 'Only database backup files of the same plog version can be imported',
    ...
    'import_zip_only' => 'Only plog backup ZIP files can be imported, and the ZIP filename cannot be modified!',
    'import_sql_only' => 'Only plog backup SQL files can be imported',
    'read_backup_error' => 'Failed to read backup file, check file permissions',
    'not_plog_backup' => 'The file is not an plog data backup file',
    'version_mismatch' => 'Not a data backup generated by the current version, please install plog %s to import.',
    'not_plog_pro_backup' => 'The file is not an plog pro data backup file',
