...
Template Name: 默认模板
Version: 1.2.3
Template Url: https://www.plog.net/template/detail/1167
Description: 系统默认模板
Author: plog
Author Url: https://www.plog.net/profiles/cf75dc06
*/
...
<head>
    ...
    <link href="<?= TEMPLATE_URL ?>css/style.css?v=<?= $v ?>&t=<?= Option::PLOG_VERSION_TIMESTAMP ?>" rel="stylesheet" />
    <link href="<?= TEMPLATE_URL ?>css/icon/iconfont.css?v=<?= $v ?>&t=<?= Option::PLOG_VERSION_TIMESTAMP ?>" rel="stylesheet" />
    <link href="<?= TEMPLATE_URL ?>css/markdown.css?v=<?= $v ?>&t=<?= Option::PLOG_VERSION_TIMESTAMP ?>" rel="stylesheet" />
    <script src="<?= TEMPLATE_URL ?>js/jquery.min.3.5.1.js?v=<?= $v ?>&t=<?= Option::PLOG_VERSION_TIMESTAMP ?>"></script>
    <script src="<?= TEMPLATE_URL ?>js/common_tpl.js?v=<?= $v ?>&t=<?= Option::PLOG_VERSION_TIMESTAMP ?>"></script>
    <script src="<?= TEMPLATE_URL ?>js/zoom.js?v=<?= $v ?>&t=<?= Option::PLOG_VERSION_TIMESTAMP ?>"></script>
