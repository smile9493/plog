...
class EmLang
{
    ...
    {
        $langFile = PLOG_ROOT . '/content/languages/' . $this->_currentLanguage . '/main.php';
        if (file_exists($langFile)) {
            $this->_langData = include $langFile;
        } else {
            $this->_langData = include PLOG_ROOT . '/content/languages/' . self::DEFAULT_LANGUAGE . '/main.php';
        }
        $langFile = PLOG_ROOT . '/content/languages/' . $this->_currentLanguage . '/main_js.php';
        if (file_exists($langFile)) {
            $this->_langJsData = include $langFile;
        } else {
            $this->_langJsData = include PLOG_ROOT . '/content/languages/' . self::DEFAULT_LANGUAGE . '/main_js.php';
        }
    }
    ...
    {
        $this->_currentLanguage = $lang;
        $langFile = PLOG_ROOT . '/content/languages/' . $this->_currentLanguage . '/install.php';
        if (file_exists($langFile)) {
            $this->_langInstallData = include $langFile;
        } else {
            $langFile = PLOG_ROOT . '/content/languages/' . self::DEFAULT_LANGUAGE . '/install.php';
            if (file_exists($langFile)) {
                $this->_langInstallData = include $langFile;
            }
        }
