...
$env_plog_env = getenv('PLOG_ENV');
$env_db_host = getenv('PLOG_DB_HOST');
$env_db_name = getenv('PLOG_DB_NAME');
$env_db_user = getenv('PLOG_DB_USER');
$env_db_password = getenv('PLOG_DB_PASSWORD');
...
?>
    ...
    <body>
        <form name="form1" method="post" action="install.php?action=install">
            <div class="main">
                <p class="logo"></p>
                <p class="title mb20">plog <?= Option::PLOG_VERSION ?></p>
                <?php if ($env_db_user): ?>
                    <div class="b">
                        ...
                        <input name="dbprefix" type="hidden" value="plog_">
                    </div>
                ...
                <?php else: ?>
                    <div class="b mb20">
                        ...
                        <div class="input-group mb10">
                            ...
                            <input name="dbprefix" type="text" class="form-control" value="plog_">
                        </div>
                        <div class="mb10">
        ...
        <div class="footer">Powered by <a href="https://www.plog.net">plog</a></div>
    </body>
...
EOT;
    ...
    if (!is_writable(PLOG_ROOT . '/content/cache')) {
...
INSERT INTO {$db_prefix}comment (gid, date, poster, comment) VALUES (1, '" . time() . "', 'plog', '" . _langInstall('demo_comment_content') . "');
...
('blogurl','" . BLOG_URL . "'),
('icp',''),
('footer_info','powered by <a href=\"https://www.plog.net\">plog</a>'),
('rss_output_num','10'),
...
INSERT INTO {$db_prefix}link (id, sitename, siteurl, icon, description, taxis) VALUES (1, 'PLOG', 'https://www.plog.net', '', '" . _langInstall('plog_official_homepage') . "', 0);
...
CREATE TABLE {$db_prefix}blog_fields (
    ...
    if ($env_plog_env === 'develop' || ($env_plog_env !== 'develop' && !@unlink('./install.php'))) {
